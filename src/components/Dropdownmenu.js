...
function Dropdownmenu(){
    const countries_cities =[
        { countries_name: "Select Countries" ,value:""},
       { countries_name: "pakistan" ,value:"pakistan" , cities:["karachi","islamabad","lahore"]},
       { countries_name: "usa" ,value:"usa" , cities:["chicago","houston","new york"]}
